...
function increaseCounter2() {
  if (counter2 < 63) {
    ...
    setTimeout(increaseCounter2, 20); // Aumenta cada 100 milisegundos (ajusta según tu preferencia)
  }
}
...
function increaseCounter3() {
  if (counter3 < 36) {
    ...
    setTimeout(increaseCounter3, 20); // Aumenta cada 100 milisegundos (ajusta según tu preferencia)
  }
}