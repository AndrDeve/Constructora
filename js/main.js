...
window.addEventListener("scroll", () => {
  ...
  const scrollStart = 500; // Cambia esto según tus necesidades
...
function increaseCounter() {
  if (counter < 120) {
    ...
    setTimeout(increaseCounter, 20); // Aumenta cada 100 milisegundos (ajusta según tu preferencia)
  }
}
...
window.addEventListener("scroll", () => {
  ...
  // Define la posición del scroll en la que deseas que comience el contador
  const scrollStart2 = 500; // Cambia esto según tus necesidades
...
function increaseCounter2() {
  if (counter2 < 63) {
    ...
    setTimeout(increaseCounter2, 15); // Aumenta cada 100 milisegundos (ajusta según tu preferencia)
  }
}
...
window.addEventListener("scroll", () => {
  ...
  // Define la posición del scroll en la que deseas que comience el contador
  const scrollStart3 = 500; // Cambia esto según tus necesidades
...
function increaseCounter3() {
  if (counter3 < 96) {
    ...
    setTimeout(increaseCounter3, 15); // Aumenta cada 100 milisegundos (ajusta según tu preferencia)
  }
}
